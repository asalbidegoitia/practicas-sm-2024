...
<div class="profile-area" id="profile-area"> 
    <section> 
        <table class="table table-striped table-bordered">
         ...
         <button onclick="eliminarUniversidadSeleccionada()" class="btn btn-danger">Eliminar Universidad Seleccionada</button> <!-- Bot�n para eliminar universidad seleccionada -->
    </section> 
</div>
...
<script> 
	...
	function logout() {
		// Redireccionar a la p�gina index.jsp
...
<script>
    // Funci�n para resaltar la fila seleccionada y almacenar su UID
    ...
    // Funci�n para eliminar la universidad seleccionadaa
    ...
    function eliminarUniversidadSeleccionada() {
	    if (uidSeleccionado !== null) {
	        ...
	        xhttp.onreadystatechange = function() {
	            if (this.readyState == 4 && this.status == 200) {
	                // La universidad se elimin� correctamente
